...
// la llamaremos sin nada dentro
function SuperObject() {}
// Para poder acceder el metodo estatico
SuperObject.isObject = function (subject) {
  if (subject === null || Array.isArray(subject)) return false;
  return typeof subject === "object";
};
// La validacion se rompe con arrays y genera error por que un arrray tambien es un objeto
// Los arrays son instancias del super prototipo Array que hereda del superprototipo Object
